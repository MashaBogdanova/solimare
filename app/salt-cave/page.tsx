    ...
    <section className={styles.saltCave}>
      ...
      <div className={styles.text}>
        ...
        <p className={styles.paragraph}>
          ...
          oddechowe, a także działa kojąco na skórę. Groty solne są szczególnie
          polecane osobom cierpiącym na choroby układu oddechowego, takie jak
          astma czy kaszel. Sól zawarta w grocie jest bogata w mikroelementy,
          które korzystnie wpływają na organizm. Grota solna może być stosowana
          w celach terapeutycznych, a także jako sposób na relaks i odprężenie.
        </p>
        <p className={styles.paragraph}>
          ...
          koncentrację mikrocząstek i jest bardziej skoncentrowaną formą terapii
          solnej.
        </p>
      </div>
    </section>
